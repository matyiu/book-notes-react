        ...
        <SidebarContainer>
            <div>
                ...
                <Accordion title="State" fontSize="22">
                    ...
                    <Link fontSize="18" href="#">In progress</Link>
                    <Link fontSize="18" href="#">Completed</Link>
                </Accordion>
                <Accordion title="Categories" fontSize="22">
                    <Link fontSize="18" href="#">Fantasy</Link>
                    <Link fontSize="18" href="#">Biography</Link>
                    <Link fontSize="18" href="#">Medieval</Link>
                </Accordion>
